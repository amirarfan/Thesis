...
File: mnist_prinvar.py

Performing selection of images on MNIST data with Prinvar technique, with different amount of images, calculating training set and CV accuracy
